...
namespace pollo
{
    ...
    {
        vkDestroyShaderModule(polloDevice.device(), vertShaderModule, nullptr);
        vkDestroyShaderModule(polloDevice.device(), fragShaderModule, nullptr);
        vkDestroyPipeline(polloDevice.device(), graphicsPipeline, nullptr);
    }
    ...
    void PolloPipeline::createGraphicsPipeline(const std::string &vertFilePath, const std::string &fragFilePath, const PipelineConfigInfo &configInfo)
    {
        ...
        if (vkCreateGraphicsPipelines(polloDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS)
        {
    ...
    PipelineConfigInfo PolloPipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height)
    {
